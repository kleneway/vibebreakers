...
export const StrengthStoryteller: React.FC<StrengthStoryteller> = ({
  ...
  const saveEvidence = (superpowerId: string) => {
    ...
    const updatedSuperpowers = superpowers.map((sp) =>
      sp.id === superpowerId ? { ...sp, evidence, impact } : sp,
    );
    ...
    <div className="space-y-6">
      <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-lg">
        ...
        <p className="text-orange-800 dark:text-orange-200 mb-4">
          Provide specific evidence for each superpower. Focus on specific
          actions and their positive impacts.
        </p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleEvidenceChange(superpower.id, e.target.value)
                  }
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleImpactChange(superpower.id, e.target.value)
                  }
              ...
              <div className="flex justify-end">
                <Button
                  ...
                  size="sm"
                  disabled={
                    !evidenceInputs[superpower.id]?.trim() &&
                    !superpower.evidence
                  }
                >
                  Save Evidence
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="text-blue-700 dark:text-blue-300">
              "When Sarah noticed Tom looking uncertain, she paused the
              conversation and asked 'What are your thoughts on this?' This made
              Tom feel comfortable sharing his valuable insights."
            </p>
          </div>
          <div>
            <p className="font-medium text-blue-800 dark:text-blue-200 mb-1">
            ...
            <p className="text-blue-700 dark:text-blue-300">
              "Mike connected our discussion about communication with the
              earlier point about trust, helping us see how these topics build
              on each other."
            </p>
          </div>
        </div>
