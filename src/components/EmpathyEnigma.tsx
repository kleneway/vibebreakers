...
const SCENARIOS: EmpathyScenario[] = [
  ...
  },
  {
    ...
    description:
      "You're offered a dream job that requires moving across the country, but your aging parent needs daily care. What factors do you consider most important?",
    category: "personal",
    difficulty: 3,
  },
  {
    ...
    description:
      "Your team member hasn't contributed to a critical project due tomorrow. You could do their work yourself or report them to your supervisor. What do you choose?",
    category: "social",
    difficulty: 2,
  },
  {
    ...
    description:
      "You unexpectedly inherit $50,000. You have student loans, your friend needs help with medical bills, and you've wanted to travel. How do you allocate this money?",
    category: "resource",
    difficulty: 2,
  },
];
...
export const EmpathyEnigma: React.FC<EmpathyEnigmaProps> = ({
  ...
  const getPhaseTitle = (): string => {
    switch (gameState.phase) {
      case "setup":
        return "Welcome to Empathy Enigma";
      case "scenario":
        return "Understanding the Scenario";
      case "prediction":
        return "Predicting Others' Responses";
      case "response":
        return "Sharing Your Response";
      case "analysis":
        return "Analyzing Predictions";
      case "discussion":
  ...
  const getPhaseDescription = (): string => {
    switch (gameState.phase) {
      case "setup":
        return "Get ready to explore how well you understand others' decision-making processes.";
      case "scenario":
        return "Read and understand the current dilemma. Think about how you and others might respond.";
      case "prediction":
        return "Predict how other participants will respond to this scenario.";
      case "response":
        return "Share your own response to the scenario and explain your reasoning.";
      case "analysis":
        return "See how well you predicted others' responses and discover surprising insights.";
      case "discussion":
        return "Discuss the results and explore what you learned about each other.";
      case "complete":
        return "Thank you for playing! Reflect on the insights you've gained.";
      default:
        return "";
    }
  };
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 text-center">
                ...
                <div className="mb-8">
                  ...
                  <div className="text-left space-y-2 text-slate-600 dark:text-slate-400">
                    <p>
                      1. <strong>Scenario:</strong> Read a complex dilemma
                      together
                    </p>
                    <p>
                      2. <strong>Predict:</strong> Guess how others will respond
                    </p>
                    <p>
                      3. <strong>Respond:</strong> Share your own decision
                    </p>
                    <p>
                      4. <strong>Analyze:</strong> See how well you predicted
                      others
                    </p>
                    <p>
                      5. <strong>Discuss:</strong> Explore insights and
                      surprises
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-aurora-100 to-blossom-100 dark:from-aurora-900 dark:to-blossom-900 rounded-2xl shadow-lg p-8 text-center">
                ...
                <div className="text-slate-600 dark:text-slate-400">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    <li>
                      Understanding others requires looking beyond surface
                      reactions
                    </li>
                    <li>
                      Different life experiences shape how we approach decisions
                    </li>
                    <li>
                      Empathy grows through genuine curiosity about others'
                      perspectives
                    </li>
                  </ul>
                </div>
                {onGameComplete && (
                  <Button
                    onClick={() => onGameComplete(gameState)}
                    className="mt-6"
                  >
                    Save Results
                  </Button>
