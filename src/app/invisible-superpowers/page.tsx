...
import { InvisibleSuperpowers, Player, Superpower } from "@/components/InvisibleSuperpowers";
      ...
      <div className="max-w-2xl mx-auto p-6 space-y-8">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
          ...
          <ul className="text-blue-800 dark:text-blue-200 text-sm space-y-2">
            <li>🔍 <strong>Observation:</strong> Watch others during casual conversation</li>
            <li>🦸‍♀️ <strong>Identification:</strong> Assign creative superpower names to others</li>
            <li>📝 <strong>Evidence:</strong> Provide specific examples of each superpower</li>
            <li>🎉 <strong>Ceremony:</strong> Celebrate each person's unique strengths</li>
            <li>💭 <strong>Reflection:</strong> Discuss insights and surprises</li>
          </ul>
        </div>
